...
function renderHome() {
  ...
  <section class="hero">
    ...
    <div class="hero-arrows" style="position:absolute;top:50%;width:100%;display:flex;justify-content:space-between;padding:0 2rem;z-index:20;transform:translateY(-50%);pointer-events:none">
      <button class="nav-icon-btn" onclick="prevSlide()" style="pointer-events:auto;background:var(--surface);border:var(--border-w) solid var(--border)">&larr;</button>
      <button class="nav-icon-btn" onclick="nextSlide()" style="pointer-events:auto;background:var(--surface);border:var(--border-w) solid var(--border)">&rarr;</button>
    </div>
    ...
    <div class="container">
      <div class="catalogue-toolbar" style="display:flex;justify-content:space-between;align-items:center;margin-bottom:3rem;border-bottom:var(--border-w) solid var(--border);padding-bottom:1rem">
        ...
        <div style="display:flex;gap:1rem">
          <div class="layout-toggle" style="display:flex;gap:0.5rem">
            <button class="btn btn-sm mono" onclick="setGridLayout('grid-2')" style="padding:0.5rem;font-size:0.7rem" title="2 Column View">||</button>
            <button class="btn btn-sm mono" onclick="setGridLayout('grid-4')" style="padding:0.5rem;font-size:0.7rem" title="4 Column View">||||</button>
          </div>

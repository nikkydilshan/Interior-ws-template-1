...
const PRODUCTS = [
  ...
  { id:15, name:"Children's Wardrobe — Colourful", category:"hinged-wardrobe", room:"cupboards", price:22000, originalPrice:null, description:"Fun and functional children's wardrobe with coloured panels, low hanging rod, toy shelf and soft-close doors.", dimensions:"W 120 × D 50 × H 180 cm", colors:["Blue & White","Pink & White","Green & White"], stock:"in-stock", badge:"", gradient:["#5A6A7A","#ebdcc6"], material:"MDF + PU Paint", style:"Kids" },
  ...
  { id:24, name:"3D Wall Mural — Nature Theme", category:"murals", room:"paintings", price:350, originalPrice:420, description:"Custom-printed 3D wall mural with nature themes. Peel-and-stick or paste application. Price per sq ft.", dimensions:"Per Sq Ft (Min 50 Sq Ft)", colors:["Forest","Waterfall","Mountain","Beach"], stock:"in-stock", badge:"New", gradient:["#1E1E1E","#c5a059"], material:"Premium Vinyl / Fabric", style:"3D Mural" },
  ...
  { id:31, name:"Decorative Table Lamp — Ceramic", category:"table-lamps", room:"lighting", price:4999, originalPrice:null, description:"Hand-glazed ceramic base table lamp with fabric shade. Available in multiple artisan-finished colours.", dimensions:"Dia 30 × H 55 cm", colors:["Teal Crackle","Terracotta","Grey Speckle","White Marble Effect"], stock:"in-stock", badge:"Artisan", gradient:["#4A4545","#f5eedf"], material:"Ceramic & Fabric", style:"Artisan" },
